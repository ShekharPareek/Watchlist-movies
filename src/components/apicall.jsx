    ...
    <>
      ...
      <div className="mt-9 w-full mb-10">
        <form onSubmit={handleSubmit}>
          ...
          />
          <button className="iniine bg-red-600 p-[9px] text-white rounded-l-none rounded-lg -ml-[12px] border-red-400">
            Search
          </button>
        </form>
      </div>
      ...
      {moviedata && moviedata.length > 0 ? (
        ...
        <div
              ...
              >
                <div className="relative mx-4 mt-4 overflow-hidden text-white shadow-lg rounded-xl bg-blue-gray-500 bg-clip-border shadow-blue-gray-500/40">
                  <img src={"https://images.unsplash.com/photo-1590179068383-b9c69aacebd3?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3Dy"} alt="movie-poster" />
                </div>
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <h5 className="block font-sans text-[18px] antialiased font-medium leading-snug tracking-normal text-blue-gray-900">
