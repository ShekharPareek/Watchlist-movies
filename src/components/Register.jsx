            ...
            {getEmail ? (
                ...
                <form onSubmit={handleSubmit} className="w-full max-w-xl bg-slate-100 my-[128px] mx-auto rounded-lg shadow-xl p-6">
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div className="w-full md:w-full px-3 mb-6">
                            <button
                                className="appearance-none block w-full bg-red-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-blue-500 focus:outline-none focus:bg-white focus:border-gray-500"
                                type="submit"
                            >
                                Sign in
                            </button>
